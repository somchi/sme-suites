...
export const CompactTemplate = () => {
  ...
  const renderProducts = () => {
    return state.products.map((item: Product) => {
      return <CompactTable key={item.id} item={item} state={state} />;
    });
  };
      ...
      <div className="grid px-6 py-2">
        ...
        <div className="flex justify-between my-3">
          ...
          <div className="grid">
            ...
            >
              {pathname === PUBLIC_RECEIPT_PREVIEW.href ? 'Receipt' : 'Invoice'}
            </h2>
            <span
              style={{ color: state.brandColor.textColor }}
              className={`text-sm`}
        ...
        <div className="w-full overflow-x-auto">
          <div className="overflow-x-auto">
            <Table
              ...
              striped
              hoverable
              style={{ borderColor: state.brandColor.border }}
            >
              <Table.Head>
                <Table.HeadCell
        ...
        <div
          style={{ borderColor: state.brandColor.border }}
          className={`grid md:w-1/2 gap-2 border border-t-0  w-72 justify-self-end`}
        >
