        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Generate Invoice</h3>
                    <p className="text-gray-500 dark:text-gray-400">Generate your free & customizable invoice.</p>
                    <Link href="/invoice">Click here</Link>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Product Cost</h3>
                    <p className="text-gray-500 dark:text-gray-400">Calculate the cost of producing an Item.</p>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Inventory (Raw Materials)</h3>
                    <p className="text-gray-500 dark:text-gray-400">Keep tab on materials you use for production.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        <svg className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>                    
                    </div>
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Stock (Products)</h3>
                    <p className="text-gray-500 dark:text-gray-400">Keep record of what you still have to sell.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Finance - Revenue & Profits</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Orders Tracker</h3>
